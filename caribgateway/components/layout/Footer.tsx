...
const destinationLinks = [
  ...
  { label: "St. Kitts & Nevis", href: "/destinations/nassau" },
];
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {destinationLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-brand-slate hover:text-white text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
              <Link key={item} href="#" className="text-brand-slate hover:text-white text-xs transition-colors">
                {item}
              </Link>
            ))}
          </div>
